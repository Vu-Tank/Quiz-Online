...
public class UpdateViewController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("cbxsubject", question.getSubjectID());
            request.setAttribute("cbxStatus", question.isStatus());
            request.setAttribute("txtQuestion", question.getQuestionName());
            request.setAttribute("txtQuestionID", question.getQuestionID());
            ArrayList<QuestionChoiceDTO> answers=question.getQuestionChoice();
            request.setAttribute("answers", answers);
        } catch (Exception e) {
            log("Error at UpdateViewController: "+e.toString());
        }finally{
